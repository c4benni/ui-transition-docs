<template>
  <Wireframe class="flex flex-col">
        ...
        :class="[
          'scale-100 translate-y-0 flex-shrink-0 flex-grow rounded-none clip-none text-[14px] h-[42px] md:h-[36px]',
          {
            ...
            'border-l border-l-gray-200 dark:border-l-gray-800 rounded-tr-[inherit]':
              i === 1,
            'border-b-[1.5px] border-primary text-primary dark:border-primary-dark dark:text-primary-dark':
              i === rotateState,
    ...
    <p class="text-paragraph dark:text-paragraph-dark px-[16px] mt-[24px]">
      Change tabs and watch Fab below for effect.
    </p>

    <Button
      class="w-[56px] h-[56px] rounded-lg text-2xl absolute right-[20px] bottom-[20px] md:bottom-[42px] md:right-[16px] translate-y-0 scale-100 shadow-2xl clip-none"
    >
      <IconWrapper>
        <Component :is="rotateState === 0 ? 'Filter' : 'NewMessage'" />
      </IconWrapper>
    </Button>
  </Wireframe>
</template>
